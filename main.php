...
**/
	...
	include('original/analysis.php');
	include('original/output.php');
	include('original/macro.php');
	include('original/util.php');
	include('original/extend_scanner.php');
	...
	if(!empty($_POST['loc']))
	{
		...
		if(empty($_POST['search']))
		{
			...
			$GLOBALS['vul_count']['#1'] = 0;
			$GLOBALS['vul_count']['#2'] = 0;
			...
			for($fit=0; $fit<$file_amount; $fit++)
			{
				...
				// scan
				$scan = new ExtendScanner($file_scanning, $scan_functions, $info_functions, $source_functions);
				$scan->parse();
	...
	echo '#3 Static vulnerability : ';echo $GLOBALS['vul_count']['#3'];echo '<br>';
